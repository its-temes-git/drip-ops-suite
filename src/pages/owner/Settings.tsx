const Settings = () => (
  <div className="space-y-8">
    <header>
      ...
      <p className="text-xs tracking-widest text-muted-foreground">SYSTEM PREFERENCES</p>
    </header>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="border border-border bg-card p-6 space-y-3">
        <h2 className="font-display text-2xl">BRANCH</h2>
      ...
      <div className="border border-border bg-card p-6 space-y-3">
        <h2 className="font-display text-2xl">LOW STOCK THRESHOLD</h2>
        <input type="number" defaultValue={3} className="bg-background border border-border px-3 py-2 w-32" />
      </div>
      <div className="border border-border bg-card p-6 space-y-3">
        <h2 className="font-display text-2xl">CURRENCY</h2>
